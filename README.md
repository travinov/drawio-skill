...
|---|---:|---|
| [`drawio-skill`](publish-drawio-skill/) | `1.23.0-corporate.7` | Редактируемые draw.io-диаграммы с безопасным Qwen command-input bridge, изолированным conversational multi-model create/improve/resume/trace циклом, потоковой трассировкой ролей, roadmap, git-flow и архитектурными схемами |
