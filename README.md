...
Команда rollback с `--latest` восстанавливает последнюю резервную копию,
созданную установщиком. В проверенном fake-CLI сценарии обновления предыдущей
версией была `1.24.0-corporate.5`; команда отката приведена внутри ZIP в
