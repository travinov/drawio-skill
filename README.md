...
|---|---:|---|
| [`drawio-skill`](publish-drawio-skill/) | `1.23.0-corporate.3` | Редактируемые draw.io-диаграммы с изолированным conversational multi-model create/improve/resume/trace циклом, roadmap, git-flow и архитектурными схемами |
