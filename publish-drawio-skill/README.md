...
Изолированный процесс дополнительно запускается без extension-контекста, без
доступных agent/question/todo/read/shell tools и с ограничением числа ходов.
