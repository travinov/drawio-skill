...
all role-visible tools excluded, and a bounded turn budget. Reject a child that
...
its `runtime-output.json` as failure evidence and do not start the next role.
